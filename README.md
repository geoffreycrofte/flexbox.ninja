...
[Flexbox·ninja](https://geoffreycrofte.com/flexbox-ninja) is a website made and hosted by [Geoffrey Crofte](https://geoffreycrofte.com) to help you better understand CSS Flexbox Layout Module.
...
* 3 images named `[nice-name]-big.png` (1086×648), `[nice-name].png` (362×226) and `[nice-name].svg` (362×226). If you don't know how to “iconify” your demo, leave those empty, I'll work on it for you.

Drop your name and your URL directly on your demo, I'll arrange the footer for you, because mentions are due.
...
If you've got any idea or need, [contact me on Bluesky](https://bsky.app/profile/geoffreycrofte.bsky.social).

## Website Next Steps

The Website is a [PWA](https://en.wikipedia.org/wiki/Progressive_web_applications). This step is finally done.
The next step will be better handling the cache for offline usage. You can already visit the demos when you are offline, if you visited those being online.
